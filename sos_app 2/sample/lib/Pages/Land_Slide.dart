  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/landslide.jpg', // Replace with your image file path
            fit: BoxFit.cover,
          ),
          Column(
            children: [
              SizedBox(
                ...
                child: CarouselSlider(
                  items: [
                    buildImageWithLink(
                      imageUrl: 'assets/landslide1.jpg',
                      link: 'https://example.com/landslide-link1',
                    ),
                    buildImageWithLink(
                      imageUrl: 'assets/landslide2.jpg',
                      link: 'https://example.com/landslide-link2',
                    ),
              ...
              Center(
                child: Column(
                  ...
                  children: <Widget>[
                    const Text(
                      'This is the Land Slide Emergency Page',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 24,
                      ),
