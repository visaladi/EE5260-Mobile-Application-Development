  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/water.jpg', // Replace with your image file path
            fit: BoxFit.cover,
          ),
          Column(
            children: [
              SizedBox(
                ...
                child: CarouselSlider(
                  items: [
                    buildImageWithLink(
                      imageUrl: 'assets/water1.jpg',
                      link: 'https://example.com/water-link1',
                    ),
                    buildImageWithLink(
                      imageUrl: 'assets/water2.jpg',
                      link: 'https://example.com/water-link2',
                    ),
