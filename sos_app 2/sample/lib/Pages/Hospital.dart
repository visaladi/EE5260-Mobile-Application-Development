  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/hospital.jpg', // Replace with your image file path
            fit: BoxFit.cover,
          ),
          Column(
            children: [
                ...
                child: CarouselSlider(
                  items: [
                    buildImageWithLink(
                      ...
                      link: 'https://example.com/hospital-link1',
                    ),
                    buildImageWithLink(
                      imageUrl: 'assets/hospital2.jpg',
                      link: 'https://example.com/hospital-link2',
                    ),
              ...
              Center(
                child: Column(
                  ...
                  children: <Widget>[
                    const Text(
                      'This is the Hospital Emergency Page',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 24,
                      ),
