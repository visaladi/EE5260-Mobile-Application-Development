  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/flood.jpg', // Replace with your image file path
            fit: BoxFit.cover,
          ),
          Column(
            children: [
              SizedBox(
                ...
                child: CarouselSlider(
                  items: [
                    buildImageWithLink(
                      imageUrl: 'assets/flood1.jpg',
                      link: 'https://example.com/flood-link1',
                    ),
                    buildImageWithLink(
                      imageUrl: 'assets/flood2.jpg',
                      link: 'https://example.com/flood-link2',
                    ),
              ...
              Center(
                child: Column(
                  ...
                  children: <Widget>[
                    const Text(
                      'This is the Flood Emergency Page',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 24,
                      ),
