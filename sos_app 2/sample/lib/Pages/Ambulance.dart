  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/ambulance.jpg', // Replace with your image file path
            fit: BoxFit.cover,
          ),
          Column(
            children: [
              SizedBox(
                ...
                child: CarouselSlider(
                  items: [
                    buildImageWithLink(
                      imageUrl: 'assets/fir1.jpg',
                      link: 'https://example.com/link1',
                    ),
                    buildImageWithLink(
                      imageUrl: 'assets/fir2.jpg',
                      link: 'https://example.com/link2',
                    ),
                    buildImageWithLink(
                      imageUrl: 'assets/fir3.jpg',
              ...
              Center(
                child: Column(
                  ...
                  children: <Widget>[
                    const Text(
                      'This is the Ambulance Emergency Page',
                      style: TextStyle(
                        color: Colors.red,
                        fontSize: 24,
                      ),
