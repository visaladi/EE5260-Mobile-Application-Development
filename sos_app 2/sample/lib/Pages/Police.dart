  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/police.jpg', // Replace with your image file path
            fit: BoxFit.cover,
          ),
          Column(
            children: [
              SizedBox(
                ...
                child: CarouselSlider(
                  items: [
                    buildImageWithLink(
                      imageUrl: 'assets/police1.jpg',
                      link: 'https://example.com/police-link1',
                    ),
                    buildImageWithLink(
                      imageUrl: 'assets/police2.jpg',
                      link: 'https://example.com/police-link2',
                    ),
              ...
              Center(
                child: Column(
                  ...
                  children: <Widget>[
                    const Text(
                      'This is the Police Emergency Page',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 24,
                      ),
